 ...
 * @param {Object} data - State data with page, y, and timestamp
 * @param {string} source - Source of the update for logging
 * @param {number} [delay=0] - Delay before showing marker (ms)
 */
function applyStateUpdate(data, source, delay = 0) {
    ...
    if (data.timestamp || data.last_update_time) {
        lastUpdateTimestamp = data.timestamp || data.last_update_time;
    }
 ...
 * @param {number} y - Y coordinate in PDF points (optional)
 */
