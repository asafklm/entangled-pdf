"""Tests for entangledpdf.routes.static_files.setup_static_files."""
...
def test_setup_static_files_mounts_static(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("entangledpdf.routes.static_files.get_settings", lambda: dummy_settings)

    from entangledpdf.routes.static_files import setup_static_files
